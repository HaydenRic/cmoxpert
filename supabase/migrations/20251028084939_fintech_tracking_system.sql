...
CREATE TABLE IF NOT EXISTS fraud_events (
  ...
  -- Cost impact
  marketing_cost_wasted decimal(12,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS verification_attempts (
  ...
  -- Cost tracking
  provider_cost decimal(8,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS fintech_metrics_daily (
  ...
  fraud_waste decimal(12,2) DEFAULT 0,
  verification_costs decimal(12,2) DEFAULT 0,

  -- CAC calculations
  cac_raw decimal(10,2),
  cac_clean decimal(10,2),
  cac_to_activation decimal(10,2),
  cac_to_transaction decimal(10,2),
