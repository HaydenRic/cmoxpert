            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {gtmPhases.map((phase, index) => (
                <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-slate-200 relative">
                  ...
                  <div className="mb-4">
                    <div className="text-sm text-slate-700 font-medium mb-1">{phase.duration}</div>
          ...
          <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-8 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="text-sm text-slate-200">Complete GTM Package</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4">
                <div className="text-2xl font-bold">8 weeks</div>
                <div className="text-sm text-slate-200">From strategy to execution</div>
              </div>
            </div>
            
            <button
              onClick={handleContactCMO}
              className="bg-white text-slate-900 px-8 py-4 rounded-lg font-semibold text-lg shadow-xl hover:shadow-2xl transition-all hover:bg-gray-100"
            >
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto mb-8">
            <div className="flex gap-4">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-lg border border-white/20 bg-white/10 backdrop-blur-sm text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white focus:border-white"
                required
              />
              <button
                type="submit"
                className="bg-white hover:bg-gray-100 text-slate-900 px-6 py-3 rounded-lg font-semibold shadow-xl hover:shadow-2xl transition-all"
              >
                Get Started
              </button>
            </div>
