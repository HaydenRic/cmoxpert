  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="relative">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-blue-300 font-semibold">Beta Program - Core Features Production-Ready</span>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-400">6 models including ML</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-400">With your data</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-400">FCA, SEC, FINRA rules</div>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-800/50 border border-blue-700/50 rounded-xl p-6">
                ...
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="px-2 py-0.5 bg-blue-500/20 text-blue-400 text-xs font-bold rounded">BETA</span>
                </div>
                <p className="text-slate-400 mb-3">
            ...
            <div className="mt-12 bg-yellow-900/20 border border-yellow-700/50 rounded-xl p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-yellow-200 text-lg mb-2">Coming in Q2 2025</h3>
        ...
        <section className="relative py-20 px-4 border-t border-slate-700/50">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center space-x-2 bg-yellow-500/20 border border-yellow-400/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-yellow-300 font-semibold">Limited Beta Pricing</span>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-slate-800/50 border-2 border-yellow-500/50 rounded-xl p-6 relative">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-4 py-1 rounded-full text-sm font-bold">
                    FOUNDING
                  </span>
                </div>
                <div className="text-3xl font-bold text-white mb-2">FREE</div>
                <div className="text-slate-400 mb-4">First 10 users only</div>
              ...
              <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                <div className="text-3xl font-bold text-white mb-2">$99<span className="text-lg text-slate-400">/mo</span></div>
                <div className="text-slate-400 mb-4">Next 40 users</div>
                <ul className="space-y-2 text-sm text-slate-300 text-left">
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 mt-0.5 text-green-400 flex-shrink-0" />
              ...
              <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                <div className="text-3xl font-bold text-white mb-2">$199<span className="text-lg text-slate-400">/mo</span></div>
                <div className="text-slate-400 mb-4">Beta access</div>
                <ul className="space-y-2 text-sm text-slate-300 text-left">
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 mt-0.5 text-green-400 flex-shrink-0" />
        ...
        <section className="relative py-20 px-4 bg-gradient-to-br from-blue-600 to-blue-800">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-white mb-6">
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 bg-white text-blue-600 px-12 py-5 rounded-xl font-bold text-lg shadow-2xl hover:shadow-3xl transition-all hover:scale-105"
            >
              <span>Join Beta Waitlist</span>
              <ArrowRight className="w-5 h-5" />
            </a>
