/*
  # Client Onboarding Flow Database Schema
  ...
  2. Security
    ...
    - Add policies for users to manage their own onboarding progress

  3. Functions
    - Auto-create onboarding progress when client is created
    - Helper functions for updating and completing onboarding
*/
